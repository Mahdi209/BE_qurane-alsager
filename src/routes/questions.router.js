...
const uploadExcel = require('../middleware/excelUpload'); // الرافع الجديد
...
router.get('/template', questionsController.downloadQuestionsTemplate);
...
router.get(
  ...
  verifyToken,
  canReadQuestion,
  questionsController.getAllQuestionsForDashboard,
);
...
router.get(
  ...
  verifyToken,
  canReadQuestion,
  questionsController.getAllQuestionsForDashboardBlock,
);
...
router.patch(
  ...
  verifyToken,
  canUpdateQuestion,
  questionsController.updateStatusQuestion,
);
...
router.delete(
  ...
  isSupervisor,
  canDeleteQuestion,
  questionsController.permanentDelete,
);

router.patch('/restore/:id', verifyToken, canUpdateQuestion, questionsController.restoreQuestion);

router.post(
  '/:categoryId/:AgeGroupId/import',
  verifyToken,
  uploadExcel.single('file'),
  questionsController.importQuestionsByExcel,
);
